...
while(1){
    ...
    else if(strcmp(addr,"74:E5:43:C3:B8:77")==0)//MAC �ּ� Ȯ���Ͽ� ���ٸ� ����Ʈ.
    {
      printf("%s is driving\n",name);
    }
    else if(strcmp(addr,"74:E5:43:C3:B8:77")!=0) //�ּҰ��� �ٸ��ٸ� Ȯ�ε��� ���� ����
    {
      printf("undefined device\n");
      err++;
    }
    else if(strcmp(name,"[unknown]")==0)//�ֺ����Ⱑ Ž������ �ʾ�������
    {
    err++;
    }
